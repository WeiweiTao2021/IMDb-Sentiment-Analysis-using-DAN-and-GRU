...
def train(model: nn.Module,
    ...
    for epoch in range(num_epochs):
        ...
        for index, (batch_inputs, batch_labels) in enumerate(generator_tqdm):
            with torch.no_grad(): ## no gradient optimization for testing
        ...
        ## within each epoch compare the best model
...
if __name__ == '__main__':
    ...
    #call data.py to load the data
    print("Reading training instances.")
    # contains text tokens and labels
    ...
    if args.load_serialization_dir:
        ...
        ## data.py to build up vocabulary
    ...
    ## replace tokens using token ids
